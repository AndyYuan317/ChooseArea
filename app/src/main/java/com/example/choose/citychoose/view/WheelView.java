...
import com.example.choose.citychoose.view.myinterface.OnWheelClickedListener;
import com.example.choose.citychoose.view.myinterface.OnWheelScrollListener;
import com.example.choose.citychoose.view.myinterface.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.titleGrey));
		// 设置线宽
