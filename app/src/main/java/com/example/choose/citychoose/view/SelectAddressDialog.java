package com.example.choose.citychoose.view;
...
import com.example.choose.OrderAddress;
import com.example.choose.R;
import com.example.choose.UIUtils;
import com.example.choose.citychoose.XmlParserHandler;
import com.example.choose.citychoose.model.CityModel;
import com.example.choose.citychoose.model.DistrictModel;
import com.example.choose.citychoose.model.ProvinceModel;
import com.example.choose.citychoose.view.adapter.ArrayWheelAdapter;
import com.example.choose.citychoose.view.myinterface.OnWheelChangedListener;
...
public class SelectAddressDialog implements OnClickListener,
    ...
    public SelectAddressDialog(Activity context,
                               SelectAddressInterface selectAdd, int type, String[] mProvinceDatas, OrderAddress orderAddress) {
        this.selectAdd = selectAdd;
        this.type = type;
        this.mAddress = orderAddress;
        this.context = context;
        View overdiaView = LayoutInflater.from(context).inflate(R.layout.dialog_select_address, null);
        ...
        switch (v.getId()) {
            case R.id.btn_confirm:
                ...
                UIUtils.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
                        mAddress.setAddress(mCurrentProviceName + mCurrentCityName + mCurrentDistrictName);
                    }
                });
//                mAddress.setAddress(mCurrentProviceName + mCurrentCityName + mCurrentDistrictName);
                overdialog.cancel();
